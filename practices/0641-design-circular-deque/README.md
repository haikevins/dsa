<h2><a href="https://leetcode.com/problems/design-circular-deque/?envType=problem-list-v2&envId=orxhe4ns&">641. Design Circular Deque</a></h2><h3>Medium</h3><hr><p>Design your implementation of the circular double-ended queue (deque).</p>
